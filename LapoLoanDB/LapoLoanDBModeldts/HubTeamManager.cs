...
public partial class HubTeamManager
{
    [Key]
    ...
    public bool? IsReconciliationOfficers { get; set; }

    [ForeignKey("CreatedByAccountId")]
    [InverseProperty("HubTeamManagerCreatedByAccounts")]
    public virtual SecurityAccount? CreatedByAccount { get; set; }

    [ForeignKey("HubTeamSubGroupId")]
    [InverseProperty("HubTeamManagers")]
    ...
    [InverseProperty("HubTeamManagerRemovedByAccounts")]
