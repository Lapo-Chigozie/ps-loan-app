...
{
    public class NetPaysBackgroundServices
    {
        ...
        public event EventHandler<ClientNetPayINFOEventArgs> onReaderClosed;

        public event EventHandler<ClientNetPayINFOEventArgs> onValidatingExcelSheetNames;

        public event EventHandler<ClientNetPayINFOEventArgs> onReadAllExcelSheetNames;

        public event EventHandler<ClientNetPayINFOEventArgs> onReadErrorExcelSheetName;

        public event EventHandler<ClientNetPayINFOEventArgs> onReadering;

        public event EventHandler<ClientNetPayINFOEventArgs> onConnectionOpen;
        public event EventHandler<ClientNetPayINFOEventArgs> onConnectionClosed;

        public event EventHandler<ClientNetPayINFOEventArgs> onExcelConcateUrl;
        ...
        public NetPaysBackgroundServices(ControllerBase controllerBase, IConfiguration configuration
)
        {
        ...
        private async Task<RespondMessageDto> ValidateClientNetPaysByDate(long ClientId, DateTime StartDate, DateTime EndDate)
        {
            ...
            try
            {
                ...
                {
                    if (this.onValidatingExcelSheetNames != null)
                    {
                        this.onValidatingExcelSheetNames(this, new ClientNetPayINFOEventArgs { Code = 200, Data = null, NPFDate = DateTime.Now, Message = "Validation Processed", Title = "Validation" });
                    }
                ...
                if (this.onValidatingExcelSheetNames != null)
                {
                    this.onValidatingExcelSheetNames(this, new ClientNetPayINFOEventArgs { Code = 200, Data = null, NPFDate = DateTime.Now, Message = "Validation Not Processed", Title = "Validation" });
                }
            ...
            catch (Exception ex)
            {
                ...
                if (this.onValidatingExcelSheetNames != null)
                {
                    this.onValidatingExcelSheetNames(this, new  ClientNetPayINFOEventArgs { Code = 402, Data = null, NPFDate = DateTime.Now,  Message = "Validation Error, " +  ex.Message  ?? ex.InnerException.Message, Title= "Validation Error" });
                }
        ...
        private async void OpenExcelConnection()
        {
            try
            {
                ...
                if (this.excelConnection.State == System.Data.ConnectionState.Closed)
                {
                    ...
                    {
                        this.onConnectionOpen(this, new ClientNetPayINFOEventArgs { Code = 200, Data = null, NPFDate = DateTime.Now, Message = "Connection Opened", Title = "Connection" });
                    }
                }
            ...
            catch (Exception ex)
            {
                ...
                if (this.onConnectionOpen != null)
                {
                    this.onConnectionOpen(this, new ClientNetPayINFOEventArgs { Code = 402, Data = null, NPFDate = DateTime.Now, Message = "Validation Error, " + ex.Message ?? ex.InnerException.Message, Title = "Validation Error" });
                }
        ...
        private async void CloseExcelConnection()
        {
            try
            {
                ...
                if (this.excelConnection.State == System.Data.ConnectionState.Open)
                {
                    ...
                    {
                        this.onConnectionClosed(this, new ClientNetPayINFOEventArgs { Code = 200, Data = null, NPFDate = DateTime.Now, Message = "Close Excel Connection", Title = "Close Excel Connection" });
                    }
                }
            ...
            catch (Exception ex)
            {
                if (this.onConnectionClosed != null)
                {
                    this.onConnectionClosed(this, new ClientNetPayINFOEventArgs { Code = 402, Data = null, NPFDate = DateTime.Now, Message = "Close Excel Connection, " + ex.Message ?? ex.InnerException.Message, Title = "Close Excel Connection" });
                }
            }
        }
        ...
        private void ConnectDbUrl(string fullPath)
        {
            try
            {
                ...
                if (this.onExcelConcateUrl != null)
                {
                    this.onExcelConcateUrl(this, new ClientNetPayINFOEventArgs { Code = 200, Data = null, NPFDate = DateTime.Now, Message = "Connect Db Url, ", Title = "Connect Db Url" });
                }
            }
            catch(Exception ex)
            {
                if (this.onExcelConcateUrl != null)
                {
                    this.onExcelConcateUrl(this, new ClientNetPayINFOEventArgs { Code = 402, Data = null, NPFDate = DateTime.Now, Message = "Connect Db Url Error, " + ex.Message ?? ex.InnerException.Message, Title = "Connect Db Url Error" });
                }
            }
        }
        ...
        private async Task<List<string>> ReadAllExcelSheetNames(DataTable dataTables)
        {
            ...
            try
            {
                if ((dataTables != null))
                {
                    ...
                    if (this.onReadAllExcelSheetNames != null)
                    {
                        this.onReadAllExcelSheetNames(this, new ClientNetPayINFOEventArgs { Code = 200, Data = null, NPFDate = DateTime.Now, Message = "Counting all excel sheet", Title = "Counting all excel sheet" });
                    }
                ...
                if (this.onReadAllExcelSheetNames != null)
                {
                    this.onReadAllExcelSheetNames(this, new ClientNetPayINFOEventArgs { Code = 402, Data = null, NPFDate = DateTime.Now, Message = "Counting all excel sheet not found", Title = "Counting all excel sheet" });
                }
            ...
            catch (Exception ex)
            {
                if (this.onReadAllExcelSheetNames != null)
                {
                    this.onReadAllExcelSheetNames(this, new ClientNetPayINFOEventArgs { Code = 402, Data = null, NPFDate = DateTime.Now, Message = "Counting all excel sheet error, " + ex.Message ?? ex.InnerException.Message, Title = "Counting all excel sheet" });
                }
            ...
            try
            {
                ...
                if (DataSheetRows.Count > 0)
                {
                    ...
                    if (DataSheetRows.Count > 1 && DataSheetRows[1] != null)
                    {
                        ...
                        oda2.Fill(dtExcel2);
                        this.Loop2Stage = NetPaysEnum.HasSheet2;
                        this.CloseExcelConnection();
                    }
                    ...
                    if (DataSheetRows.Count > 2 && DataSheetRows[2] != null)
                    {
                        ...
                        oda3.Fill(dtExcel3);
                        this.Loop3Stage = NetPaysEnum.HasSheet3;
                        this.CloseExcelConnection();
                    }
        ...
        public async Task<RespondMessageDto> SaveAllNetPaysAsync(DataTable dataTable1, DataTable dataTable2, DataTable dataTable3, DateTime StartUploadTime)
        {
            try
            {
                ...
                if (this.Loop2Stage == NetPaysEnum.HasSheet2)
                {
                    this.Loop2Stage = NetPaysEnum.StartSheet;
                    Task.Run(() => this.SaveSheet2NetPaysAsync(dataTable2).Wait());
                }

                if (this.Loop3Stage == NetPaysEnum.HasSheet3)
                {
                    this.Loop3Stage = NetPaysEnum.StartSheet;
                ...
                if (this.Loop1Stage == NetPaysEnum.HasError || this.Loop2Stage == NetPaysEnum.HasError || this.Loop3Stage == NetPaysEnum.HasError)
                {
                    dataTable1 = null;
                    dataTable2 = null;
                    dataTable3 = null;
                ...
                else if (this.Loop1Stage == NetPaysEnum.Finished && this.Loop2Stage == NetPaysEnum.None && this.Loop3Stage == NetPaysEnum.None)
                {
                    dataTable1 = null;
                    dataTable2 = null;
                    dataTable3 = null;
                ...
                else if (this.Loop2Stage == NetPaysEnum.Finished || this.Loop1Stage == NetPaysEnum.HasError || this.Loop3Stage == NetPaysEnum.HasError)
                {
                    dataTable1 = null;
                    dataTable2 = null;
                    dataTable3 = null;
                ...
                else if (this.Loop3Stage == NetPaysEnum.Finished || this.Loop1Stage == NetPaysEnum.HasError || this.Loop2Stage == NetPaysEnum.HasError)
                {
                    dataTable1 = null;
                    dataTable2 = null;
                    dataTable3 = null;
                ...
                else if (this.Loop3Stage == NetPaysEnum.Finished && this.Loop2Stage == NetPaysEnum.Finished && this.Loop1Stage == NetPaysEnum.Finished)
                {
            ...
            try
            {
                ...
                try
                {
                    foreach (DataRow row in dataTable3.Rows)
                    {
                        ...
                        {
                            this.Sheet3HasDateError = NetPaysEnum.HasDateError;
                        }
                    ...
                    dataTable3 = null;
                    this.CloseExcelConnection();
                    this.Loop3Stage = NetPaysEnum.Finished;
                }
                catch (Exception exp1)
                {
                    dataTable3 = null;
                    this.CloseExcelConnection();
                    this.Loop3Stage = NetPaysEnum.HasError;
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                try
                {
                    foreach (DataRow row in dataTable2.Rows)
                    {
                        ...
                        {
                            this.Sheet2HasDateError = NetPaysEnum.HasDateError;
                        }
                    ...
                    dataTable2 = null;
                    this.CloseExcelConnection();
                    this.Loop2Stage = NetPaysEnum.Finished;
                }
                catch (Exception exp1)
                {
                    dataTable2 = null;
                    this.CloseExcelConnection();
                    this.Loop2Stage = NetPaysEnum.HasError;
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                try
                {
                    foreach (DataRow row in dataTable1.Rows)
                    {
                        ...
                        {
                            this.Sheet1HasDateError = NetPaysEnum.HasDateError;
                        }
